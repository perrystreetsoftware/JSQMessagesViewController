Pod::Spec.new do |s|
	...
	s.resources = ['JSQMessagesViewController/Assets/JSQMessagesAssets.bundle', 'JSQMessagesViewController/**/*.{xib}', 'JSQMessagesViewController/**/*.{storyboard}']
