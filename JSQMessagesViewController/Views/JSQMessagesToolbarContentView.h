...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *searchResultsContainerViewHeightConstraint;
...
@property (readonly, nonatomic) CGFloat searchResultsContainerViewContentHeight;
